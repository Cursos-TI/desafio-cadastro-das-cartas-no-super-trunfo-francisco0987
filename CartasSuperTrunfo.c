...
int main() {
    ...
    int pib = pib1 > pib2;
    int pontos_turisticos = n_pontos_turisticos1 > n_pontos_turisticos2;
    int densidade_populacional = densidade_populacional1 > densidade_populacional2;
    int pib_per_capita = pib_per_capta1 > pib_per_capta2;
    int super_poder = super_poder_carta1 > super_poder_carta2;

    printf("População: Carta 1: %u | Carta 2: %u | Resultado: %d\n", populacao1, populacao2, populacao);
    printf("Área: Carta 1: %.2f | Carta 2: %.2f | Resultado: %d\n", area1, area2, area);
    printf("PIB: Carta 1: %.2f | Carta 2: %.2f | Resultado: %d\n", pib1, pib2, pib);
    printf("Pontos turísticos: Carta 1: %d | Carta 2: %d | Resultado: %d\n", n_pontos_turisticos1, n_pontos_turisticos2, pontos_turisticos);
